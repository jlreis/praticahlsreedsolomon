...
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module rs_erasure_F_tbl_rom (
...
initial begin
    $readmemh("./rs_erasure_F_tbl_rom.dat", ram0);
    $readmemh("./rs_erasure_F_tbl_rom.dat", ram1);
    $readmemh("./rs_erasure_F_tbl_rom.dat", ram2);
    $readmemh("./rs_erasure_F_tbl_rom.dat", ram3);
    $readmemh("./rs_erasure_F_tbl_rom.dat", ram4);
    $readmemh("./rs_erasure_F_tbl_rom.dat", ram5);
    $readmemh("./rs_erasure_F_tbl_rom.dat", ram6);
    $readmemh("./rs_erasure_F_tbl_rom.dat", ram7);
end
...
rs_erasure_F_tbl_rom rs_erasure_F_tbl_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
